<div class="usermetas index">
	...
	<tr>
		...
		<td><?php echo h($usermeta['Usermeta']['meta_key']); ?>&nbsp;</td>
		<td><?php echo h($usermeta['Usermeta']['meta_value']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $usermeta['Usermeta']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $usermeta['Usermeta']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
