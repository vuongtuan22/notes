...
<?php echo $this->Form->create('Commentmeta'); ?>
	<fieldset>
		<legend><?php echo __('Edit Commentmeta'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Commentmeta.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Commentmeta.id'))); ?></li>
