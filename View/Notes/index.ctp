<div class="notes index">
	...
	<tr>
		...
		<td><?php echo h($note['Note']['thumnail']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['created']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['modified']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['excerpt']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['slug']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['comment_count']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['view_counter']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['comment_status']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['parent']); ?>&nbsp;</td>
		<td><?php echo h($note['Note']['note_type']); ?>&nbsp;</td>
